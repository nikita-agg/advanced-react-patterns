...
const ClapCount = ({ count }) => {
  return <span className={styles.count} id='clapCount'> + {count}</span>
}
const CountTotal = ({ countTotal }) => {
  return <span className={styles.total} id="clapCountTotal"> {countTotal}</span>
}
